...
OutputDir=installer
OutputBaseFilename=PulseSetup_v1.0.1
...
[Run]
Filename: "schtasks.exe"; Parameters: "/Create /TN ""PulseMonitor"" /TR ""\""{app}\Pulse.exe\"""" /SC ONLOGON /RL HIGHEST /F"; Flags: runhidden; Tasks: startupentry
Filename: "{app}\Pulse.exe"; Description: "Launch Pulse"; Flags: nowait postinstall skipifsilent runascurrentuser

[UninstallRun]
Filename: "schtasks.exe"; Parameters: "/Delete /TN ""PulseMonitor"" /F"; Flags: runhidden; RunOnceId: "DelPulseTask"
